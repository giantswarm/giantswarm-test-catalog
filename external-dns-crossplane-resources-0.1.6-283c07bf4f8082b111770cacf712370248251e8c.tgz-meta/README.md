...
Giant Swarm offers a external-dns-crossplane-resources App which can be installed in workload clusters.
Here we define the external-dns-crossplane-resources chart with its templates and default configuration.
