...
Giant Swarm offers a agentic-platform App which can be installed in workload clusters.
Here, we define the agentic-platform chart with its templates and default configuration.
