...
The chart's configuration values are documented in the auto-generated
[`helm/external-secrets/README.md`](helm/external-secrets/README.md) file. This file is
produced by [helm-docs](https://github.com/norwoodj/helm-docs) from comments in `values.yaml`.

A JSON schema for validating user-supplied `values.yaml` files is available at
[`helm/external-secrets/values.schema.json`](helm/external-secrets/values.schema.json). It is
generated by [helm-values-schema-json](https://github.com/losisin/helm-values-schema-json) and
validated with [schemalint](https://github.com/giantswarm/schemalint).

Both files are kept up-to-date automatically via pre-commit hooks.
