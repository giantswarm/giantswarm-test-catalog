...
OPSGENIE_INTEGRATIONS='[{"api_key": "key1", "integration_id": "id1"}, {"api_key": "key2", "integration_id": "id2", "pagerduty_service_id": "P2NNTFM"}]'
...
The optional `pagerduty_service_id` field maps a PagerDuty service to an Opsgenie integration. When a PagerDuty `incident.triggered` event arrives from a mapped service, the proxy creates a new Opsgenie alert in the corresponding integration. Incidents with `[ServiceNow]` in the title are skipped.
