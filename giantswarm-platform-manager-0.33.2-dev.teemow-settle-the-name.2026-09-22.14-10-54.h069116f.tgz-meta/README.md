...
Giant Swarm's **platform manager**: enables, reconciles and verifies platform capabilities on
installations as the person, through MCP tools behind muster. Every write is a pull request to the
installation's GitOps repository, opened as the person; nothing is applied to a cluster directly.
